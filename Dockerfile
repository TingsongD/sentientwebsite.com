...
ARG VITE_SENTIENT_WIDGET_ORIGIN
ARG VITE_SENTIENT_INSTALL_KEY
...
ENV VITE_SENTIENT_WIDGET_ORIGIN=$VITE_SENTIENT_WIDGET_ORIGIN
ENV VITE_SENTIENT_INSTALL_KEY=$VITE_SENTIENT_INSTALL_KEY
